...
class SecondActivity : AppCompatActivity(),OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reset.setOnClickListener {
            ...
            button8.text = ""
            button9.text = ""
            button1.setBackgroundColor(Color.parseColor("#4D0000"))
            button2.setBackgroundColor(Color.parseColor("#4D0000"))
            button3.setBackgroundColor(Color.parseColor("#4D0000"))
            button4.setBackgroundColor(Color.parseColor("#4D0000"))
            button5.setBackgroundColor(Color.parseColor("#4D0000"))
            button6.setBackgroundColor(Color.parseColor("#4D0000"))
            button7.setBackgroundColor(Color.parseColor("#4D0000"))
            button8.setBackgroundColor(Color.parseColor("#4D0000"))
            button9.setBackgroundColor(Color.parseColor("#4D0000"))
    ...
    private fun check() {
        ...
        if (winner == 1){
            Toast.makeText(this, "საღოლ $player1", Toast.LENGTH_SHORT).show()
            angarish1 += 1
            activeplayer = 1
        }else if(winner == 2){
            Toast.makeText(this, "საღოლ $player2", Toast.LENGTH_SHORT).show()
            angarish2 += 1
            activeplayer = 2
        }else if(firstPlayer.size + secondPlayer.size == 9){
            Toast.makeText(this, "ფრეა ბლ", Toast.LENGTH_SHORT).show()
